...
var SavingEfficiencyCard = (function (_super) {
    ...
    SavingEfficiencyCard.prototype.render = function () {
        return (React.createElement("div", {className: "SavingEfficiencyCard"}, 
            React.createElement("div", {id: "SavingEfficiencyGaugeChart"}), 
            React.createElement("div", {className: "SavingEfficiencyCard-MonthYearText"}, this.state.monthYearText), 
            React.createElement("div", {className: "SavingEfficiencyCard-Title"}, this.state.title), 
            React.createElement("div", {className: "SavingEfficiencyCard-InformationText"}, this.state.informationText)));
    };
