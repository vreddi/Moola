...
var SnippetTile = (function (_super) {
    ...
    SnippetTile.prototype.render = function () {
        ...
        return (React.createElement("div", {className: "SnippetTile-Card"}, 
            React.createElement("div", {className: cardTypeClassName}, 
                React.createElement("i", {className: fontAwesomeClassName, "aria-hidden": "true"})
            ), 
            React.createElement("div", {className: "SnippetTile-CardHeading"}, this.state.heading), 
            React.createElement("div", {className: "SnippetTile-CardTitle"}, this.state.title), 
            React.createElement("div", {className: "SnippetTile-CardValue"}, this.state.value)));
    };
